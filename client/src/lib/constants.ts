...
export const testimonials = [
  {
    ...
    text: "The team at Bakemono J Garage is very helpful and affordable. They fixed my car's transmission problem quickly and the service was excellent.",
    rating: 5,
    initials: "AH"
  },
  {
    ...
    name: "Sarah Lee",
    location: "Shah Alam",
    text: "I brought my vintage Datsun here and they did an amazing job on the restoration. Their knowledge of classic cars is impressive. Highly recommended!",
    rating: 5,
    initials: "SL"
  },
  {
    ...
    text: "Regular customer for over 2 years now. Their diagnostic services are top-notch and they always explain what needs to be fixed before doing the work.",
    rating: 4.5,
    initials: "RK"
  }
];
...
export const contactInfo = {
  ...
  phoneNote: "Call or WhatsApp for inquiries: 017-295 2514",
  hours: {
    hq: "9 AM – 6 PM (HQ)",
